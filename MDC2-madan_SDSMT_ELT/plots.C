
{
  ...
  ofstream myfileg;
  ofstream myfilegfit;
  myfile.open ("May_study/zslice_plot_JR_merge_May/Electron_Lifetime.txt");
  myfileg.open ("May_study/zslice_plot_JR_merge_May/Electron_Lifetime_gauss.txt");
  myfilegfit.open("May_study/zslice_plot_JR_merge_May/Gaussian_fit_par.txt");


  stringstream ss;
  TF1* fLifetime = new TF1("fLifetime", "[0] + [j]*x", 50., 1300.);
  TF1* fLifetime1 = new TF1("fLifetime1", "[0] + [j]*x", 50., 1300.);
  fLifetime1->SetLineColor(2);
  TF1* fLifetime2 = new TF1("fLifetime2", "[0] + [j]*x", 50., 1300.);
  fLifetime2->SetLineColor(2);

  //TF1* fLifetime3 = new TF1("fLifetime3", "[0] + [j]*x", 0., 1350.);
  ...
  TGraphErrors *gXemean = new TGraphErrors();
  ...
  for(int day = 1; day <= 31; ++day)
    {
      //if(day == 2 || day == 18) //days not processed
       //continue;
      ss.str("");
      ss << "May_study/root_Zslices_merge_May/merge_May_day_";
      if(day < 10)
       ss << "0";
...
/*
   // For Sz Vs Drift time
      ...
      c->Print("May_study/zslice_plot_JR_merge_May/mygif.gif+50");
      c->WaitPrimitive();*/
      ...
      hS2zc->SetMaximum(50);
      hS2zc->Draw("colz");
      hS2zc->Fit(fLifetime1, "R");


      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/S2VsZc_";
      if(day < 10)
       ss << "0";
      ss << day << ".png";
      ...
      c2->Print("May_study/zslice_plot_JR_merge_May/mygif1.gif+50");
      c2->WaitPrimitive();
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/dTVsZc_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      c3->Print("May_study/zslice_plot_JR_merge_May/mygif2.gif+50");
      c3->WaitPrimitive();

/*
      // For electron lifetime (Andrew & Brais..)
      float b = fLifetime->GetParameter(1);
      cout << "b = " << b << endl;
      float lt = -1/(log(10)*fLifetime->GetParameter(1));
      cout << "lt = " << "-1/(log(10)*b = " << lt << "us" << endl;
      gXe131m_->SetPoint(i, float(day), lt);
      float lterr = fLifetime->GetParError(1)/(log(10)* (b*b));
      gXe131m_->SetPointError(i, 0.5, lterr);*/

      // Madan's method
      float al = -1/(log(10)*fLifetime1->GetParameter(1));
      float d = fLifetime2->GetParameter(1);
      float elt = al * d;
      gXe131m->SetPoint(i, float(day), elt);
      float err_al = fLifetime1->GetParError(1);
      float alerr = err_al/((log(10)*fLifetime1->GetParameter(1)*fLifetime1->GetParameter(1)));
      float derr = fLifetime2->GetParError(1);
...
/*
  ...
  //         for(int j = 0; j <= 1; j++)
   //   {
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_0_50_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      l20.Draw();
      //c20->Print(ss.str().c_str());
      c20->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_0_50.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_50_100_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
     ...
     // c2n->Print(ss.str().c_str());
      c2n->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_50_100.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_100_150_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c21->Print(ss.str().c_str());
      ...
      //c21->Print(ss.str().c_str());
      c21->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_100_150.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_150_200_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      //c22->Print(ss.str().c_str());
      c22->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_150_200.gif+50");
     ...
     //slice 5
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_200_250_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      c23->Print(ss.str().c_str());
      c23->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_200_250.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_250_300_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
     ...
     // c24->Print(ss.str().c_str());
      c24->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_250_300.gif+50");
     ...
     //slice 7
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_300_350_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c25->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_300_350.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_350_400_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c26->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_350_400.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_400_450_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c27->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_400_450.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_450_500_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c28->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_450_500.gif+50");
     ...
     //slice 11
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_500_550_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c29->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_500_550.gif+50");
     ...
     //slice 12
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_550_600_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c30->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_550_600.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_600_650_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c31->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_600_650.gif+50");
     ...
     //slice 14
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_650_700_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c32->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_650_700.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_700_750_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c33->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_700_750.gif+50");
     ...
     //slice 16
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_750_800_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c34->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_750_800.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_800_850_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c35->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_800_850.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_850_900_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c36->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_850_900.gif+50");
     ...
     //slice 19
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_900_950_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c37->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_900_950.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_950_1000_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
     ...
     // c38->Print(ss.str().c_str());
      c38->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_950_1000.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1000_1050_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      c24->Print(ss.str().c_str());
      ...
      c39->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1000_1050.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1050_1100_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c40->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1050_1100.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1100_1150_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c41->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1100_1150.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1150_1200_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c42->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1150_1200.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1200_1250_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c43->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1200_1250.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1250_1300_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c44->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1250_1300.gif+50");
      ...
      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/hS2zc_1300_1350_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      cl->Print(ss.str().c_str());
      cl->SaveAs("May_study/zslice_plot_JR_merge_May/hS2zc_1300_1350.gif+50");
      ...
      TH1F* h1    = new TH1F("h1", " log10(S2 [phd]); Zc", 28, 50., 1400.);
     ...
     // gXemean->
      ...
      float thisXg[27] = {25, 75, 125, 175, 225, 275, 325, 375, 425, 475, 525, 575, 625, 675, 725, 775,
      ...
      gMeans->Draw("AP");
       ...
       //c5->cd();
       TF1* fLifetime3 = new TF1("fLifetime3", "[0] + [j]*x", 50., 1300.);
       fLifetime3->SetLineColor(2);
       fLifetime3->SetLineWidth(1);
       //gMeans->Draw("AP");
       //gMeans->Fit("pol1");
       gMeans->Fit(fLifetime3, "R");
       //gMeans->Fit(fLifetime, "R");
       //h1->Draw();
       //h1->Fit(fLifetime3, "R");

      ss.str("");
      ss << "May_study/zslice_plot_JR_merge_May/gMeans";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      float al_g = -1/(log(10)*fLifetime3->GetParameter(1));
      float d_g = fLifetime2->GetParameter(1);
      float elt_g = al_g * d_g;
      gXe131mGausFits->SetPoint(i, float(day), elt_g);
      float err_al_g = fLifetime3->GetParError(1);
      float alerr_g = err_al_g/((log(10)*fLifetime3->GetParameter(1)*fLifetime3->GetParameter(1)));
      float derr_g = fLifetime2->GetParError(1);
      ...
      //c5->Print(ss.str().c_str());
      c5->SaveAs("May_study/zslice_plot_JR_merge_May/gMeans.gif+50");
      c5->WaitPrimitive();
...
/*  TLegend lg(0.3, 0.5, 0.5, 0.7);
  ...
  c4->Print("Output_April/ltXe131m.png");
...
/*
  ...
  cg->Print("May_study/zslice_plot_JR_merge_May/ltXe131mGausFits_23.png");
  ...
  legAll->Draw();
  cAll->Print("May_study/zslice_plot_JR_merge_May/ltXe131mAllMethods.png");
