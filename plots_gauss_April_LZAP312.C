
{
  ...
  ofstream myfileg;
  ofstream myfilegfit;
  myfile.open ("April_ELT_study/April_zslice_plot_merge/Electron_Lifetime.txt");
  myfileg.open ("April_ELT_study/April_zslice_plot_merge/Electron_Lifetime_gauss.txt");
  myfilegfit.open("April_ELT_study/April_zslice_plot_merge/Gaussian_fit_par.txt");
  ...
  for(int day = 1; day <= 30; ++day)
    {
      //if(day == 2 || day == 18) //days not processed
       //continue;
      ss.str("");
      ss << "April_ELT_study/root_Zslices_merge_April/merge_zSlices_LZAP312_SS_April_";
      if(day < 10)
       ss << "0";
     ...
     continue;
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/S2VsZc_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      c2->Print("April_ELT_study/April_zslice_plot_merge/mygif1.gif+50");
      c2->WaitPrimitive();
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/dTVsZc_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      c3->Print("April_ELT_study/April_zslice_plot_merge/mygif2.gif+50");
      c3->WaitPrimitive();
      ...
      int j;
       ...
       hS2zc_0_50->GetXaxis()->SetRangeUser(5, 6);
        ...
        //hS2zc_0_50->GetXaxis()->SetRangeUser(5, 6); 
        if ( ((xmax*7.0/800.) + 1.) > 5.820 ) upperBound = 5.820; else upperBound = ((xmax*7.0/800.) + 1.);
        fGausS2->SetRange((xmax*7.0/800.) - 1., upperBound); 
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_0_50_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      l20.Draw();
      //c20->Print(ss.str().c_str());
      c20->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_0_50.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_50_100_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      c2n->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_50_100.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_100_150_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c21->Print(ss.str().c_str());
      ...
      //c21->Print(ss.str().c_str());
      c21->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_100_150.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_150_200_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      //c22->Print(ss.str().c_str());
      c22->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_150_200.gif+50");
     ...
     //slice 5
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_200_250_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      //c23->Print(ss.str().c_str());
      c23->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_200_250.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_250_300_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      //c24->Print(ss.str().c_str());
      c24->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_250_300.gif+50");
     ...
     //slice 7
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_300_350_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c25->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_300_350.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_350_400_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c26->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_350_400.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_400_450_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c27->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_400_450.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_450_500_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c28->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_450_500.gif+50");
     ...
     //slice 11
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_500_550_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c29->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_500_550.gif+50");
     ...
     //slice 12
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_550_600_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c30->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_550_600.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_600_650_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c31->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_600_650.gif+50");
     ...
     //slice 14
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_650_700_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c32->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_650_700.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_700_750_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c33->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_700_750.gif+50");
     ...
     //slice 16
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_750_800_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c34->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_750_800.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_800_850_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c35->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_800_850.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_850_900_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c36->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_850_900.gif+50");
     ...
     //slice 19
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_900_950_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      c37->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_900_950.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_950_1000_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c38->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_950_1000.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1000_1050_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      c24->Print(ss.str().c_str());
      ...
      c39->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1000_1050.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1050_1100_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c40->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1050_1100.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1100_1150_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c41->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1100_1150.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1150_1200_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c42->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1150_1200.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1200_1250_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c43->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1200_1250.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1250_1300_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      c44->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1250_1300.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/hS2zc_1300_1350_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      //cl->Print(ss.str().c_str());
      cl->SaveAs("April_ELT_study/April_zslice_plot_merge/hS2zc_1300_1350.gif+50");
    ...
    // fitted gmean
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_merge/gMeans";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      //c5->Print(ss.str().c_str());
      c5->SaveAs("April_ELT_study/April_zslice_plot_merge/gMeans.gif+50");
      c5->WaitPrimitive();
  ...
  c4->Print("April_ELT_study/April_zslice_plot_merge/ltXe131m.png");
  ...
  cg->Print("April_ELT_study/April_zslice_plot_merge/ltXe131mGausFits_23.png");
  ...
  legAll->Draw();
  cAll->Print("April_ELT_study/April_zslice_plot_merge/ltXe131mAllMethods.png");
