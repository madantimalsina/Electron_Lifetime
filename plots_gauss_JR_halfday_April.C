
{
  ...
  ofstream myfileg;
  ofstream myfilegfit;
  myfile.open ("April_ELT_study/April_zslice_plot_halfday/Electron_Lifetime.txt");
  myfileg.open ("April_ELT_study/April_zslice_plot_halfday/Electron_Lifetime_gauss.txt");
  myfilegfit.open("April_ELT_study/April_zslice_plot_halfday/Gaussian_fit_par.txt");
  ...
  for(int day = 1; day <= 61; ++day)
    {
      //if(day == 2 || day == 18) //days not processed
       //continue;
      ss.str("");
      ss << "April_ELT_study/root_Zslices_halfday_April/halfday_zSlices_LZAP312_SS_April_";
      if(day < 10)
       ss << "0";
     ...
     continue;
      ...
      hS2zc->GetXaxis()->SetTitle("Zc - Corrected Z-position [cm]");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/S2VsZc_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      TLegend l(0.70, 0.70, 0.80, 0.88);
      l.AddEntry(hS2zc, ss.str().c_str(), "");
      l.Draw();

      c2->Print("April_ELT_study/April_zslice_plot_halfday/mygif1.gif+50");
      c2->WaitPrimitive();

      // for drift time Vs Zc
      c3->cd();
      TH2F* hdTzc = (TH2F*)f.Get("hdTzc");
      hdTzc->GetXaxis()->SetTitle("Zc - Corrected Z-position [cm]");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/dTVsZc_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      TLegend l1(0.70, 0.70, 0.80, 0.88);
      l1.AddEntry(hdTzc, ss.str().c_str(), "");
      l1.Draw();

      c3->Print("April_ELT_study/April_zslice_plot_halfday/mygif2.gif+50");
      c3->WaitPrimitive();
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_0_50_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l20(0.75, 0.72, 0.89, 0.88);
      l20.AddEntry(hS2zc_0_50, ss.str().c_str(), "");
      l20.Draw();
      //c20->Print(ss.str().c_str());
      c20->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_0_50.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_50_100_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l2n(0.75, 0.72, 0.89, 0.88);
      l2n.AddEntry(hS2zc_50_100, ss.str().c_str(), "");
      l2n.Draw();

      //c2n->Print(ss.str().c_str());
      c2n->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_50_100.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_100_150_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c21->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l21(0.75, 0.72, 0.89, 0.88);
      l21.AddEntry(hS2zc_100_150, ss.str().c_str(), "");
      l21.Draw();

      //c21->Print(ss.str().c_str());
      c21->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_100_150.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_150_200_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l22(0.75, 0.72, 0.89, 0.88);
      l22.AddEntry(hS2zc_150_200, ss.str().c_str(), "");
      l22.Draw();

      //c22->Print(ss.str().c_str());
      c22->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_150_200.gif+50");
     ...
     //slice 5
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_200_250_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l23(0.75, 0.72, 0.89, 0.88);
      l23.AddEntry(hS2zc_200_250, ss.str().c_str(), "");
      l23.Draw();

      //c23->Print(ss.str().c_str());
      c23->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_200_250.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_250_300_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l24(0.75, 0.72, 0.89, 0.88);
      l24.AddEntry(hS2zc_250_300, ss.str().c_str(), "");
      l24.Draw();

      //c24->Print(ss.str().c_str());
      c24->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_250_300.gif+50");
     ...
     //slice 7
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_300_350_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l25(0.75, 0.72, 0.89, 0.88);
      l25.AddEntry(hS2zc_300_350, ss.str().c_str(), "");
      l25.Draw();

      //c25->Print(ss.str().c_str());
      c25->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_300_350.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_350_400_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l26(0.75, 0.72, 0.89, 0.88);
      l26.AddEntry(hS2zc_350_400, ss.str().c_str(), "");
      l26.Draw();

      //c26->Print(ss.str().c_str());
      c26->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_350_400.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_400_450_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l27(0.75, 0.72, 0.89, 0.88);
      l27.AddEntry(hS2zc_400_450, ss.str().c_str(), "");
      l27.Draw();

      //c27->Print(ss.str().c_str());
      c27->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_400_450.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_450_500_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l28(0.75, 0.72, 0.89, 0.88);
      l28.AddEntry(hS2zc_450_500, ss.str().c_str(), "");
      l28.Draw();

      //c28->Print(ss.str().c_str());
      c28->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_450_500.gif+50");
     ...
     //slice 11
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_500_550_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l29(0.75, 0.72, 0.89, 0.88);
      l29.AddEntry(hS2zc_500_550, ss.str().c_str(), "");
      l29.Draw();

      //c29->Print(ss.str().c_str());
      c29->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_500_550.gif+50");
     ...
     //slice 12
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_550_600_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l30(0.75, 0.72, 0.89, 0.88);
      l30.AddEntry(hS2zc_550_600, ss.str().c_str(), "");
      l30.Draw();

      //c30->Print(ss.str().c_str());
      c30->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_550_600.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_600_650_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l31(0.75, 0.72, 0.89, 0.88);
      l31.AddEntry(hS2zc_600_650, ss.str().c_str(), "");
      l31.Draw();

      //c31->Print(ss.str().c_str());
      c31->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_600_650.gif+50");
     ...
     //slice 14
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_650_700_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l32(0.75, 0.72, 0.89, 0.88);
      l32.AddEntry(hS2zc_650_700, ss.str().c_str(), "");
      l32.Draw();

      //c32->Print(ss.str().c_str());
      c32->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_650_700.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_700_750_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l33(0.75, 0.72, 0.89, 0.88);
      l33.AddEntry(hS2zc_700_750, ss.str().c_str(), "");
      l33.Draw();

      //c33->Print(ss.str().c_str());
      c33->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_700_750.gif+50");
     ...
     //slice 16
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_750_800_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l34(0.75, 0.72, 0.89, 0.88);
      l34.AddEntry(hS2zc_750_800, ss.str().c_str(), "");
      l34.Draw();

      //c34->Print(ss.str().c_str());
      c34->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_750_800.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_800_850_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l35(0.75, 0.72, 0.89, 0.88);
      l35.AddEntry(hS2zc_800_850, ss.str().c_str(), "");
      l35.Draw();

      //c35->Print(ss.str().c_str());
      c35->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_800_850.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_850_900_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l36(0.75, 0.72, 0.89, 0.88);
      l36.AddEntry(hS2zc_850_900, ss.str().c_str(), "");
      l36.Draw();

      //c36->Print(ss.str().c_str());
      c36->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_850_900.gif+50");
     ...
     //slice 19
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_900_950_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c23->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l37(0.75, 0.72, 0.89, 0.88);
      l37.AddEntry(hS2zc_900_950, ss.str().c_str(), "");
      l37.Draw();

      //c37->Print(ss.str().c_str());
      c37->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_900_950.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_950_1000_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l38(0.75, 0.72, 0.89, 0.88);
      l38.AddEntry(hS2zc_950_1000, ss.str().c_str(), "");
      l38.Draw();

      //c38->Print(ss.str().c_str());
      c38->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_950_1000.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1000_1050_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l39(0.75, 0.72, 0.89, 0.88);
      l39.AddEntry(hS2zc_1000_1050, ss.str().c_str(), "");
      l39.Draw();

      //c39->Print(ss.str().c_str());
      c39->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1000_1050.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1050_1100_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l40(0.75, 0.72, 0.89, 0.88);
      l40.AddEntry(hS2zc_1050_1100, ss.str().c_str(), "");
      l40.Draw();

      //c40->Print(ss.str().c_str());
      c40->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1050_1100.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1100_1150_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l41(0.75, 0.72, 0.89, 0.88);
      l41.AddEntry(hS2zc_1100_1150, ss.str().c_str(), "");
      l41.Draw();

      //c41->Print(ss.str().c_str());
      c41->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1100_1150.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1150_1200_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l42(0.75, 0.72, 0.89, 0.88);
      l42.AddEntry(hS2zc_1150_1200, ss.str().c_str(), "");
      l42.Draw();

      //c42->Print(ss.str().c_str());
      c42->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1150_1200.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1200_1250_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l43(0.75, 0.72, 0.89, 0.88);
      l43.AddEntry(hS2zc_1200_1250, ss.str().c_str(), "");
      l43.Draw();

      //c43->Print(ss.str().c_str());
      c43->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1200_1250.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1250_1300_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      //c24->Print(ss.str().c_str());
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend l44(0.75, 0.72, 0.89, 0.88);
      l44.AddEntry(hS2zc_1250_1300, ss.str().c_str(), "");
      l44.Draw();

      //c44->Print(ss.str().c_str());
      c44->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1250_1300.gif+50");
      ...
      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/hS2zc_1300_1350_";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Day_" << day;
      TLegend ll(0.75, 0.72, 0.89, 0.88);
      ll.AddEntry(hS2zc_1300_1350, ss.str().c_str(), "");
      ll.Draw();

      //cl->Print(ss.str().c_str());
      cl->SaveAs("April_ELT_study/April_zslice_plot_halfday/hS2zc_1300_1350.gif+50");
      ...
      gMeans->Draw("AP");
       ...
       TF1* linearfit3 = new TF1("linearfit3", "[0] + [j]*x", 5., 130.);
       linearfit3->SetLineColor(2);
       linearfit3->SetLineWidth(1);
       gMeans->Fit(linearfit3, "R");

      ss.str("");
      ss << "April_ELT_study/April_zslice_plot_halfday/gMeans";
      if(day < 10)
      ss << "0";
      ss << day << ".png";
      ...
      ss.str("");
      ss << "Half_day_" << day;
      TLegend l5(0.69, 0.22, 0.83, 0.39);
      l5.AddEntry(gMeans, ss.str().c_str(), "");
      l5.Draw();

      //c5->Print(ss.str().c_str());
      c5->SaveAs("April_ELT_study/April_zslice_plot_halfday/gMeans.gif+50");
      c5->WaitPrimitive();
  ...
  c4->Print("April_ELT_study/April_zslice_plot_halfday/ltXe131m.png");
  ...
  cg->Print("April_ELT_study/April_zslice_plot_halfday/ltXe131mGausFits_23.png");
  ...
  legAll->Draw();
  cAll->Print("April_ELT_study/April_zslice_plot_halfday/ltXe131mAllMethods.png");
